...
var Dajaxice = {
    ...
    show_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('events.show_event', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    show_events_list: function(callback_function, argv, custom_settings){
        return Dajaxice.call('frontend.show_events_list', 'POST', callback_function, argv, custom_settings);
    },

    say_hello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('frontend.say_hello', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    register_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.register_event', 'POST', callback_function, argv, custom_settings);
    },

    add_member: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.add_member', 'POST', callback_function, argv, custom_settings);
    },

    remove_member: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.remove_member', 'POST', callback_function, argv, custom_settings);
    },

    register_event_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.register_event_form', 'POST', callback_function, argv, custom_settings);
    },

    remove_self: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.remove_self', 'POST', callback_function, argv, custom_settings);
    },

    add_member_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.add_member_form', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    welcome: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.welcome', 'POST', callback_function, argv, custom_settings);
    },

    show_updates: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.show_updates', 'POST', callback_function, argv, custom_settings);
    },

    show_registered_tdp_events: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.show_registered_tdp_events', 'POST', callback_function, argv, custom_settings);
    },

    view_profile: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.view_profile', 'POST', callback_function, argv, custom_settings);
    },

    forgot_password: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.forgot_password', 'POST', callback_function, argv, custom_settings);
    },

    register: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.register', 'POST', callback_function, argv, custom_settings);
    },

    add_college: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.add_college', 'POST', callback_function, argv, custom_settings);
    },

    back: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.back', 'POST', callback_function, argv, custom_settings);
    },

    edit_profile_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.edit_profile_form', 'POST', callback_function, argv, custom_settings);
    },

    show_event_tdp: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.show_event_tdp', 'POST', callback_function, argv, custom_settings);
    },

    show_tdp_submissions: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.show_tdp_submissions', 'POST', callback_function, argv, custom_settings);
    },

    logout: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.logout', 'POST', callback_function, argv, custom_settings);
    },

    change_password: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.change_password', 'POST', callback_function, argv, custom_settings);
    },

    show_registered_events: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.show_registered_events', 'POST', callback_function, argv, custom_settings);
    },

    change_password_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.change_password_form', 'POST', callback_function, argv, custom_settings);
    },

    login: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.login', 'POST', callback_function, argv, custom_settings);
    },

    submit_tdp: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.submit_tdp', 'POST', callback_function, argv, custom_settings);
    },

    edit_profile: function(callback_function, argv, custom_settings){
        return Dajaxice.call('users.edit_profile', 'POST', callback_function, argv, custom_settings);
    }
